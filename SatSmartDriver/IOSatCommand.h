...
#ifndef _IOSatCOMMAND_H
#define _IOSatCOMMAND_H
...
class IOSatExtendedLBA;
class IOSatCommand;

/*! @typedef IOSatCompletionFunction callback function for ATA disk devices.
 */
typedef void(IOSatCompletionFunction)(IOSatCommand* command);

/*!
 @class IOSatCommand
 
 @discussion
 Command structure superclass, (--created and freed only by IOSatDevice objects
...
class IOSatCommand : public IOCommand {
    OSDeclareAbstractStructors(IOSatCommand);
...
public:
     ...
     */
    virtual void setCallbackPtr(IOSatCompletionFunction* inCompletion);
...
protected:
    ...
    IOSatCompletionFunction* _callback;         //  >       if nil, command is synchronous
...
private:
    OSMetaClassDeclareReservedUsed(IOSatCommand, 0); // set end result
    OSMetaClassDeclareReservedUsed(IOSatCommand, 1); // get extendedLBAPtr
    OSMetaClassDeclareReservedUnused(IOSatCommand, 2);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 3);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 4);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 5);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 6);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 7);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 8);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 9);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 10);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 11);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 12);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 13);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 14);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 15);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 16);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 17);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 18);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 19);
    OSMetaClassDeclareReservedUnused(IOSatCommand, 20);

public:
    virtual void              setEndResult(UInt8 inStatus, UInt8 endError);
    virtual IOSatExtendedLBA* getExtendedLBA(void);
};
...
/*!
 ...
 @discussion
 If 48-bit LBAs are supported, IOSatExtendedLBA is used to represent a 48-bit LBA.
 The driver examines the ATA identify data to determine if 48-bit addressing is
 supported.
 */

class IOSatExtendedLBA : public OSObject {
    OSDeclareDefaultStructors(IOSatExtendedLBA);

public:
    static IOSatExtendedLBA* createIOSatExtendedLBA(IOSatCommand* owner);
...
private:
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 0);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 1);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 2);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 3);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 4);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 5);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 6);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 7);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 8);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 9);
    OSMetaClassDeclareReservedUnused(IOSatExtendedLBA, 10);
};
